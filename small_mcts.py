...
Description: Simulates simplified version of Plants versus Zombies in a small 3x3 world that uses Monte Carlo Tree Search
...
def simulateGame():
    ...
    while True:
        ...
        if len(actions) == 0:
            ...
            action = monteCarloTreeSearch(state, actions, gamma, step) if np.random.random() <= 0.5 else 9
